...
/**
 * Clase b�sica para la gesti�n de una cabecera que se a�ade los mensajes
 * cifrados (ficheros). Permite almacenar datos de forma de array de bytes. La
 * cabecera estar� cifrada con una clave fija. Formato de la cabecera:
 * -------------------------------------------------------- |Longitud (2
 * bytes)|Datos (array de 'longitud bytes', cifrados) ... |
 * --------------------------------------------------------
 */
public class BasicHeader {
	/**
	 * M�ximna Longitud de los datos cifrados.
	 */
	...
	/**
	 * Intenta cargar los datos de una cabecera desde un InputStream ya abierto. Si
	 * tiene exito, los datos quedan en la clase.
	 * 
