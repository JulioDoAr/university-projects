...
public class Options implements Serializable {
	...
	/**
	 * Iterator counter. Número e iteraciones que hará el algoritmo a la hora de
	 * cifrar.
	 */
	 ...
	 * aplicables a un objeto: -Cifrado simétrico -Hash/Mac -Cifrado de clave
	 * publica -Firma digital
	 */
	...
	/**
	 * Nombres compuestos de algoritmos para cifrado simétrico, incluyendo Modo de
	 * operaciópn y Modo de Relleno: Algoritmo/ModoOperacion/ModoRelleno
	 */
	 ...
	 */
	public final static String algorithmSizeKey[] = { "AES", "128", "256", "ARCFOUR", "40", "1024", "DESede", "112",
			"168" };
	/**
	 ...
	 */
	public final static String signAlgorithms[] = { "none", "SHA1withRSA", "MD2withRSA", "MD5withRSA", "SHA224withRSA",
	...
	/**
	 * Devuelve el rango del tamaño de las claves de un agoritmo dado, según la
	 * Tabla definida.
	 * 
	 ...
	 * ejemplo, "AES/ECB/NoPadding", retornará "AES".
	 * 
