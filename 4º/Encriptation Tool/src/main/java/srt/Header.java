...
/**
 * Clase para la gestión de la cabecera que se añade los mensajes cifrados
 * (ficheros). Permite gestionar los diferentes atributos que se almacenan:
 * --------------------------------------------------------
...
public class Header extends BasicHeader {
	...
	/**
	 * Operación realizada, codificada segun las definiciones de
	 * <code>Options</code>
	 */
	 ...
	 */
	private String algorithm1, algorithm2;
	/**
