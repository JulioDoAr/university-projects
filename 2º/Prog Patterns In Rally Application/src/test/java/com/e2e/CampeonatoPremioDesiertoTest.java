...
class CampeonatoPremioDesiertoTest {
	...
	void test() {
		...
		log.addOutputOperation(
				new FileOutputOperation("./src/test/resources/output/SalidaDatosCampeonatoPremioDesierto.txt"));
		log.startWrite();
		log.write(
				"*********************************************************************************************************");
		log.write(
				"****ESTA SIMULACIÓN CONCLUYE ANTES DE FINALIZAR EL CAMPEONATO CON TODOS LOS PILOTOS DESCALIFICADOS****");
		log.write(
				"*********************************************************************************************************\n");
		initData();
		log.finishWrite();
